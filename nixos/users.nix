...
}:
{
  users.users.andreweggleston = {
    ...
    openssh.authorizedKeys.keys = [
      ...
      "ecdsa-sha2-nistp256 AAAAE2VjZHNhLXNoYTItbmlzdHAyNTYAAAAIbmlzdHAyNTYAAABBBDDF3zcpUFyAIELN82yt6gbvHyuJ5vEMnXxGRj+9CLqcOB7DvBs9xNXqYfgJT5wT4G5Mmk6WTt8HbJeqAiLQvrc= andreweggleston"
    ];
  };
